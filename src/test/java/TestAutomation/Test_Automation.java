...
public class Test_Automation {
    ...
    public void writeText(){
        ...
        //driver.findElement(By.id("userName")).sendKeys("Radwan");
//        driver.findElement(By.cssSelector("[type=text]")).sendKeys("Radwan");
        //driver.findElement(By.cssSelector("[id=userName]")).sendKeys("Radwan");
        //driver.findElement(By.className("form-control")).sendKeys("Radwan");
...
//                perform();
    ...
    public void uploadFile(){
        ...
        driver.findElement(By.id("uploadFile")).sendKeys("D:\\waist_coat.jpg");
    }
    @Test
